...
import 'package:kidstarter/entities/capital alphabets.dart';
...
Future<List<AlphabetEntity>> _fetchAlphabets() async {
  String jsonString = await rootBundle.loadString('assets/data/small alphabets.json');
...
class AlphabetsScreen2 extends StatefulWidget {
  final String title;
  ...
  @override
  _AlphabetsScreen2State createState() => _AlphabetsScreen2State();
}

class _AlphabetsScreen2State extends State<AlphabetsScreen2> {
